...
describe "Addresser" do
  ...
  it "implements absolute addressing" do
    expected = { address: 0x1337, pos: mem.pos + 2 }
  ...
  it "implements indirect + x addressing" do
    ...
    expected = { address: 0x1337,  pos: mem.pos + 1 }
  ...
  it "implements immediate addressing" do
    expected = { address: mem.pos, pos: mem.pos + 1 }
  ...
  it "implements implicit addressing" do
    expected = { address: nil, pos: mem.pos }
  ...
  def read(bytes, mode, params={})
    ...
    address = Vintage::Addresser.read(mem, mode, x, y)
    pos     = mem.pos
